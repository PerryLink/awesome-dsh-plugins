...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-08-19 07:41（UTC+8）。
...
| 13 | [deepseek-harness-desktop-app](https://github.com/vibeinging/deepseek-harness-desktop-app) | 409 | DeepSeek Harness Desktop App: a local AI desktop worksp… |
