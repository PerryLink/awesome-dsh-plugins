...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-08-17 13:20（UTC+8）。
...
| 3 | [modlens](https://github.com/liustack/modlens) | 2518 | The first vision plugin for DeepSeek Harness, and the v… |
| 4 | [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 1747 | 开放的侧边栏底座，支持三方拓展注册新侧边栏页面。内置文件渲染编辑/终端/Git/子代理页面 |
...
| 10 | [dsh-vision-router](https://github.com/ysr666/dsh-vision-router) | 492 | Eyes for text-only DeepSeek Harness agents: built-in fr… |
...
| 14 | [deepseek-harness-desktop-app](https://github.com/vibeinging/deepseek-harness-desktop-app) | 290 | DeepSeek Harness Desktop App: a local AI desktop worksp… |
| 15 | [dsh-at-file](https://github.com/omdsh-dev/dsh-at-file) | 288 | Codex-style @file mentions for DeepSeek Harness: search… |
...
| 18 | [dsh-browser](https://github.com/Lum1104/dsh-browser) | 217 | dsh plugin: Chrome sidebar extension that lets DSH oper… |
