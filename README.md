...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-08-24 10:49（UTC+8）。

| # | 插件 | ⭐ | 说明 |
|---|---|---|---|
| 1 | [headroom](https://github.com/headroomlabs-ai/headroom) | 67301 | Compress tool outputs, logs, files, and RAG chunks befo… |
| 2 | [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | 5777 | DeepSeek Harness（DSH）Web GUI 插件与皮肤生态：一切皆插件。任务看板、移动端远程与 … |
| 3 | [modlens](https://github.com/liustack/modlens) | 3561 | The first vision plugin for DeepSeek Harness, and the v… |
| 4 | [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 2732 | 开放的侧边栏底座，支持三方拓展注册新侧边栏页面。内置文件渲染编辑/终端/侧边对话/Git/子代理页面 ｜ Op… |
| 5 | [dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) | 2388 | DSH 官方公众号收录的 TUI 补位插件：Claude Code 风，鲸鱼顶栏/实时状态/流式思考/双击 E… |
| 6 | [TokenTracker](https://github.com/xiufengsun/TokenTracker) | 1405 | Local-first AI token usage & cost tracker for 31 coding… |
| 7 | [PicGo-Core](https://github.com/PicGo/PicGo-Core) | 980 | :zap:The ultimate image uploading engine. Both CLI & AP… |
| 8 | [dsh-vision-router](https://github.com/ysr666/dsh-vision-router) | 948 | Eyes for text-only DeepSeek Harness agents: built-in fr… |
| 9 | [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 905 | AgentTeams plugin for DeepSeek Harness |
| 10 | [dsh-vision-toolkit](https://github.com/Anionex/dsh-vision-toolkit) | 820 | [dsh]为纯文本模型设计更强大的视觉工具箱：安装免费使用、粘贴图片直接识别、多张图片问答、截图到前端UI 还… |
