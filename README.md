...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-08-23 01:41（UTC+8）。
...
| 9 | [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 825 | AgentTeams plugin for DeepSeek Harness |
