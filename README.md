...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-08-17 15:51（UTC+8）。

| # | 插件 | ⭐ | 说明 |
|---|---|---|---|
| 1 | [headroom](https://github.com/headroomlabs-ai/headroom) | 66574 | Compress tool outputs, logs, files, and RAG chunks befo… |
| 2 | [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | 3800 | Plugin and skin collection for DeepSeek Harness (DSH) W… |
| 3 | [modlens](https://github.com/liustack/modlens) | 2595 | The first vision plugin for DeepSeek Harness, and the v… |
| 4 | [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 1812 | 开放的侧边栏底座，支持三方拓展注册新侧边栏页面。内置文件渲染编辑/终端/Git/子代理页面 |
...
| 10 | [dsh-vision-router](https://github.com/ysr666/dsh-vision-router) | 523 | Eyes for text-only DeepSeek Harness agents: built-in fr… |
| 11 | [dsh-ads](https://github.com/Nagi-ovo/dsh-ads) | 475 | 把 DSH 变成 2005 年门户网站｜Parody ads, fake games, and popups … |
| 12 | [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 454 | AgentTeams plugin for DeepSeek Harness |
...
| 15 | [dsh-at-file](https://github.com/omdsh-dev/dsh-at-file) | 301 | Codex-style @file mentions for DeepSeek Harness: search… |
...
| 18 | [dsh-browser](https://github.com/Lum1104/dsh-browser) | 225 | dsh plugin: Chrome sidebar extension that lets DSH oper… |
