...
| # | Plugin | Description | ⭐ |
|---|---|---|---|
| 🥇 | [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | Official core repo: "everything is a plugin", driven by Cordis. | 195108 |
| 🥈 | [deepseek-harness-desktop](https://github.com/anywhere-labs/deepseek-harness-desktop) | Modern DeepSeek Harness desktop experience | 20177 |
| 🥉 | [awesome-dsh-plugin/awesome-dsh-plugin](https://github.com/awesome-dsh-plugin/awesome-dsh-plugin) | Community curated list (105 plugins + sites + badges). | 12639 |
...
| 5 | [deepseek-ai/awesome-deepseek-agent](https://github.com/deepseek-ai/awesome-deepseek-agent) | Official curated list of DeepSeek agents. | 5999 |
...
| 9 | [dsh-desktop](https://github.com/dataelement/dsh-desktop) | Cross-platform desktop app | 2470 |
| 10 | [dsh-market](https://github.com/dsh-market/dsh-market) | The plugin market inside DSH: a Settings page to browse and search the full community catalog by category, with confirmed one-click installs and an installed-plugins view. | 2370 |
...
| [dsh-deep-whale](https://github.com/Small-tailqwq/dsh-deep-whale) | 1714 | Whale-girl skin series for the DSH Web UI (maid-atelier). |  |
...
| [TokenLedger](https://github.com/zh667/TokenLedger) | 153 | Track local DSH token usage by relay site, project and model, and show account balance and subscription quota cycles. |  |
...
| [dsh-easyrewrite](https://github.com/Renzic-Stone/DSH-EasyRewrite) | 75 | Inline edit & recall for user message bubbles in DSH Web: lazy commit, seamless replacement, version pager, auto draft backup, trilingual i18n. | `dsh plugin add dsh-easyrewrite` |
...
| [dsh-desktop](https://github.com/dataelement/dsh-desktop) | 2470 | Cross-platform desktop app |  |
...
| [deepseek-harness-desktop](https://github.com/anywhere-labs/deepseek-harness-desktop) | 20177 | Modern DeepSeek Harness desktop experience |  |
...
| Plugin | ⭐ | Description | Install |
|---|---|---|---|
| [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 1009 | AgentTeams multi-agent teams. | `dsh plugin add dsh-agent-teams` |
...
| [dsh-im](https://github.com/xmanrui/dsh-im) | 849 | One settings entry to connect Feishu/WeChat/DingTalk/WeCom/QQ/Slack/Telegram/Discord/WhatsApp bots via QR scan, App Manifest or credentials. |  |
...
| Plugin | ⭐ | Description | Install |
|---|---|---|---|
| [dsh-browser](https://github.com/Lum1104/dsh-browser) | 456 | Chrome sidebar extension that lets DSH operate your browser directly, no vision capabilities required. |  |
...
| [dsh-market](https://github.com/dsh-market/dsh-market) | 2370 | The plugin market inside DSH: a Settings page to browse and search the full community catalog by category, with confirmed one-click installs and an installed-plugins view. | `dsh plugin add github:dsh-market/dsh-market` |
...
| [dsh-ads](https://github.com/Nagi-ovo/dsh-ads) | 567 | Parody ads in 2005-Chinese-web style: sidebar banners, in-chat feeds, corner popups, and a close button whose hit area is smaller than it looks. All fictional. | `dsh plugin add @dsh-external/dsh-ads` |
...
| Plugin | ⭐ | Description | Install |
|---|---|---|---|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | 195108 | Official core repo: "everything is a plugin", driven by Cordis. |  |
| [deepseek-ai/awesome-deepseek-agent](https://github.com/deepseek-ai/awesome-deepseek-agent) | 5999 | Official curated list of DeepSeek agents. |  |
| [awesome-dsh-plugin/awesome-dsh-plugin](https://github.com/awesome-dsh-plugin/awesome-dsh-plugin) | 12639 | Community curated list (105 plugins + sites + badges). |  |
...
| [0xsline/awesome-deepseek-harness](https://github.com/0xsline/awesome-deepseek-harness) | 900 | Curated DSH ecosystem: plugins, tools, and infrastructure. |  |
