...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-08-28 02:19（UTC+8）。

| # | 插件 | ⭐ | 说明 |
|---|---|---|---|
| 1 | [headroom](https://github.com/headroomlabs-ai/headroom) | 67807 | Compress tool outputs, logs, files, and RAG chunks befo… |
| 2 | [dsh-web](https://github.com/zhu1090093659/dsh-web) | 6276 | DeepSeek Harness（DSH）Web 插件聚合生态包 · 一切皆插件，创意工坊分发 |
| 3 | [modlens](https://github.com/liustack/modlens) | 3725 | The first vision plugin for DeepSeek Harness, and the v… |
| 4 | [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 3015 | 开放的侧边栏底座，支持三方拓展注册新侧边栏页面。内置文件渲染编辑/终端/侧边对话/Git/子代理页面 ｜ Op… |
| 5 | [dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) | 2628 | DSH 官方公众号收录的 TUI 补位插件：Claude Code 风，鲸鱼顶栏/实时状态/流式思考/双击 E… |
| 6 | [TokenTracker](https://github.com/xiufengsun/TokenTracker) | 1441 | Local-first AI token usage & cost tracker for 31 coding… |
| 7 | [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 1119 | AgentTeams plugin for DeepSeek Harness |
...
| 15 | [dsh-browser](https://github.com/Lum1104/dsh-browser) | 482 | Chrome sidebar extension that lets DeepSeek Harness ope… |
| 16 | [dsh-genui](https://github.com/omdsh-dev/dsh-genui) | 358 | GenUI for DeepSeek Harness: interactive UI components r… |
| 17 | [Abu-Cowork](https://github.com/PM-Shawn/Abu-Cowork) | 351 | Open-source alternative to Claude Cowork — a local-firs… |
| 18 | [Bigfish](https://github.com/turtle2209/Bigfish) | 303 | Bigfish —— DeepSeek Harness 的第三方桌面端，内置 Node 运行时，双击即用，附带… |
| 19 | [whale-girl](https://github.com/vlln/whale-girl) | 291 | DSH Web GUI 桌面宠物插件（QQ 宠物形态）：右下角悬浮、可拖拽/投喂/玩耍的积累型伙伴。 |
