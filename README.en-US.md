...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-08-18 14:56（UTC+8）。
...
| 3 | [modlens](https://github.com/liustack/modlens) | 2924 | The first vision plugin for DeepSeek Harness, and the v… |
...
| 5 | [dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) | 1890 | DSH 官方公众号收录的 TUI 补位插件：Claude Code 风，鲸鱼顶栏/实时状态/流式思考/双击 E… |
...
| 8 | [dsh-vision-router](https://github.com/ysr666/dsh-vision-router) | 679 | Eyes for text-only DeepSeek Harness agents: built-in fr… |
