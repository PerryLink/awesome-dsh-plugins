...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-08-16 22:43（UTC+8）。

| # | 插件 | ⭐ | 说明 |
|---|---|---|---|
| 1 | [headroom](https://github.com/headroomlabs-ai/headroom) | 66507 | Compress tool outputs, logs, files, and RAG chunks befo… |
| 2 | [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | 3278 | Plugin and skin collection for DeepSeek Harness (DSH) W… |
...
| 6 | [TokenTracker](https://github.com/xiufengsun/TokenTracker) | 1328 | Local-first AI token usage & cost tracker for 31 coding… |
...
| 11 | [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 400 | AgentTeams plugin for DeepSeek Harness |
| 12 | [dsh-vision-router](https://github.com/ysr666/dsh-vision-router) | 374 | Eyes for text-only DeepSeek Harness agents: built-in fr… |
