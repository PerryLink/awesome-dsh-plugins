...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-08-24 12:41（UTC+8）。

| # | 插件 | ⭐ | 说明 |
|---|---|---|---|
| 1 | [headroom](https://github.com/headroomlabs-ai/headroom) | 67310 | Compress tool outputs, logs, files, and RAG chunks befo… |
| 2 | [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | 5798 | DeepSeek Harness（DSH）Web GUI 插件与皮肤生态：一切皆插件。任务看板、移动端远程与 … |
| 3 | [modlens](https://github.com/liustack/modlens) | 3564 | The first vision plugin for DeepSeek Harness, and the v… |
| 4 | [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 2742 | 开放的侧边栏底座，支持三方拓展注册新侧边栏页面。内置文件渲染编辑/终端/侧边对话/Git/子代理页面 ｜ Op… |
...
| 9 | [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 914 | AgentTeams plugin for DeepSeek Harness |
...
| 17 | [dsh-genui](https://github.com/omdsh-dev/dsh-genui) | 313 | GenUI for DeepSeek Harness: interactive UI components r… |
