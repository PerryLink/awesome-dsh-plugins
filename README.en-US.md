...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-08-23 09:35（UTC+8）。

| # | 插件 | ⭐ | 说明 |
|---|---|---|---|
| 1 | [headroom](https://github.com/headroomlabs-ai/headroom) | 67204 | Compress tool outputs, logs, files, and RAG chunks befo… |
| 2 | [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | 5603 | Plugin and skin collection for DeepSeek Harness (DSH) W… |
| 3 | [modlens](https://github.com/liustack/modlens) | 3529 | The first vision plugin for DeepSeek Harness, and the v… |
...
| 5 | [dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) | 2317 | DSH 官方公众号收录的 TUI 补位插件：Claude Code 风，鲸鱼顶栏/实时状态/流式思考/双击 E… |
...
| 9 | [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 834 | AgentTeams plugin for DeepSeek Harness |
...
| 12 | [dsh-desktop](https://github.com/vibeinging/dsh-desktop) | 617 | DeepSeek Harness Desktop App: a local AI desktop worksp… |
...
| 15 | [dsh-browser](https://github.com/Lum1104/dsh-browser) | 394 | dsh plugin: Chrome sidebar extension that lets DeepSeek… |
