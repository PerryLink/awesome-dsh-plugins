...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-08-22 19:18（UTC+8）。
...
| 15 | [dsh-browser](https://github.com/Lum1104/dsh-browser) | 384 | dsh plugin: Chrome sidebar extension that lets DeepSeek… |
