...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-08-17 06:41（UTC+8）。
...
| 4 | [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 1626 | 开放的侧边栏底座，支持三方拓展注册新侧边栏页面。内置文件渲染编辑/终端/Git/子代理页面 |
